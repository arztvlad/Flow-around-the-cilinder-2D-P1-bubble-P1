...
while err>data.ns_tol && outer_it<data.ns_max_it
    ...
    [A,Bu,Bl,E,b,c,~] = assemblyP1bP1DCT_vecO(data.p,data.t,data.nu,data.f,w,delta_T,theta,ut1,ut2);
